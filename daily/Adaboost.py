...
def buildStump(dataArr, classLabels, D):
    ...
    for i in range(n):  # loop over all dimensions
        ...
        stepSize = (rangeMax - rangeMin) / m
        for j in range(m):  # loop over all range in current dimension
...
if __name__ == '__main__':
    ...
    # testArr, testLabelArr = loadDataSet('horseColicTraining2.txt')
    # adaClassify(testArr, classifierArray)
